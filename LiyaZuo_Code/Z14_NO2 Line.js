// Load table data
var table = ee.FeatureCollection('projects/ee-2024bsabd/assets/NO2x5');
        ...
        var chart = ui.Chart.array.values(ee.Array(yearData.map(function(item){
          return ee.Feature(null, item).get('value');
            ...
            .setOptions({
              ...
              hAxis: {title: 'Year'},
              vAxis: {title: 'NO2 Density (e^-5 mol/m^2)'},
              lineWidth: 1,
              pointSize: 3,
...
createAndPrintChart(cities, 'NO2 Density of ');
createAndPrintChart(districts, 'NO2 Density of ');
