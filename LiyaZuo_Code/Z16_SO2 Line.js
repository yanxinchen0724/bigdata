// Load table data
var table = ee.FeatureCollection('projects/ee-2024bsabd/assets/SO2x5');
        ...
        var chart = ui.Chart.array.values(ee.Array(yearData.map(function(item){
          return ee.Feature(null, item).get('value');
            ...
            .setOptions({
              ...
              hAxis: {title: 'Year'},
              vAxis: {title: 'SO2 Density (e^-5 mol/m^2)'},
              lineWidth: 1,
              pointSize: 3,
...
createAndPrintChart(cities, 'SO2 Density of ');
createAndPrintChart(districts, 'SO2 Density of ');
