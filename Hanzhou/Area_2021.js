//the source code is available at:https://code.earthengine.google.com/7e536e8cf2182ad5747f0ddbee9446ad?accept_repo=projects%2Fgee-edu%2Fbook
//---Pre_processing-----
...
Export.image.toAsset({
  ...
  assetId: 'projects/ee-hnyhl3/assets/Image_2021',
  scale: 30,
  region: AOI,
  maxPixels: 1e9
});
...
areaInSquareKilometers1.evaluate(function(result) {
  print('Area in shizuishan 2021:', result);
});
...
areaInSquareKilometers2.evaluate(function(result) {
  print('Area in yinchuan 2021:', result);
});
...
areaInSquareKilometers3.evaluate(function(result) {
  print('Area in wuzhong 2021:', result);
});
...
areaInSquareKilometers4.evaluate(function(result) {
  print('Area in zhongwei 2021:', result);
});
...
areaInSquareKilometers5.evaluate(function(result) {
  print('Area in guyuan 2021:', result);
});

//-----Convert raster into vector-----

// Create a fake second band with all pixel values set to 1
var fakeBand = ee.Image.constant(1);

var class0WithFakeBand = finalMask.addBands(fakeBand);

// Convert pixels classified as photovoltaic power stations to points
...
var exportParams = {
  ...
  description: 'point_2021', 
  assetId: 'projects/ee-ucfnfou/assets/2021/Point_2021', 
};
