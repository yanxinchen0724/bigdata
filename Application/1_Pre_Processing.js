...
exports.processImage = function(year) {
  // Set the start and end dates based on the passed-in year
  var start = year + '-03-01';
  var end = year + '-05-01';
  // Specify the bands of interest
  var bands = ['B2', 'B3', 'B4', 'B5', 'B6', 'B7', 'B8', 'B8A', 'B11', 'B12'];

  // Load the Sentinel-2 ImageCollection, filter by date and cloud coverage, and compute the mean
  ...
  // Retrieve the Sentinel RGB image
